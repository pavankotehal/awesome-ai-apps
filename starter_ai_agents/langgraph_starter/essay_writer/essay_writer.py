...
def build_digest_graph(interrupt_after: list[str] | None = None) -> CompiledStateGraph:
    ...
    memory = MemorySaver()
    return builder.compile(checkpointer=memory, interrupt_after=interrupt_after or [])
